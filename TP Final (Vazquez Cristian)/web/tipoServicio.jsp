...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header is-small-screen">
    ...
    <div class="mdl-layout__drawer">
        ...
        <main class="mdl-layout__content mdl-color--grey-100">
            <form action="SvTipoServicio" method="POST" class="form">
                <div class="mdl-card mdl-shadow--2dp employer-form" action="#">
                    <div class="mdl-card__title">
                        <h2>Registro de tipo de servicios</h2>
                        <div class="mdl-card__subtitle">Complete el nombre de servicio nuevo</div>
                    </div>

                    <div class="mdl-card__supporting-text">
                            <div class="form__article">
                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-size">
                                    <input class="mdl-textfield__input" type="text" name="nombreServT">
                                    <label class="mdl-textfield__label" for="nombreServT">Nombre</label>
                                </div>

                                <div class="mdl-layout-spacer"></div>
                                <a href="SvVerServicio2">
