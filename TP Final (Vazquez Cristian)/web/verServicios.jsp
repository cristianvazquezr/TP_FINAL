            ...
            <div class="mdl-cell mdl-cell--6-col-desktop mdl-cell--6-col-tablet mdl-cell--4-col-phone">
                    <div class="mdl-card mdl-shadow--2dp">
                        <div class="mdl-card__title">
                            <h1 class="mdl-card__title-text">Lista de empleados Registrados</h1>
                        </div>
                        <div class="mdl-card__supporting-text no-padding">
                            <table class="mdl-data-table mdl-js-data-table stripped-table" data-upgraded=",MaterialDataTable">
                                ...
                                <tbody>
                                    ...
                                    List <Servicio> listaServ = (List) sesion.getAttribute("listServ");                               
                                    for (Servicio serv : listaServ){%>

                                        <tr>
                                            <%int idServ = serv.getCodigo_serv();%>
                                            <td class="mdl-data-table__cell--non-numeric"><%=idServ%></td>
                                            ...
                                            <td class="mdl-data-table__cell--non-numeric"><%=origen %></td>
                                            <%String destino = serv.getDestino(); %>
                                            <td class="mdl-data-table__cell--non-numeric"><%=destino %></td>
                                            <%Double costo = serv.getCosto(); %>
                                            <td class="mdl-data-table__cell--non-numeric"><%=costo %></td>                
                                            ...
                                            <td class="mdl-data-table__cell--non-numeric">
                                                <form name="editarservicio" action="SvModificarServicio" method="post"> 
                                                    <input type="hidden" name="idServ" value="<%=idServ%>">                                          
                                                    <li class="mdl-list__item">
