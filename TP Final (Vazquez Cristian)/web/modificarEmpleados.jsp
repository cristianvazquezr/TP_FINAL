        ...
        <main class="mdl-layout__content mdl-color--grey-100">
            <div class="mdl-card mdl-shadow--2dp employer-form" action="#">
                <div class="mdl-card__title">
                    ...
                    <div class="mdl-card__subtitle">Complete los datos del nuevo empleado</div>
                </div>

                <div class="mdl-card__supporting-text">
                    <form action="SvModificarEmpleado2" method="POST" class="form">
                        <% Empleado emple = (Empleado) misession.getAttribute("empleadoModif");%>
                        <div class="form__article">
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-size">
                                <input class="mdl-textfield__input" type="text" name="nombre" value="<%=emple.getNombre()%>">
                                <label class="mdl-textfield__label" for="nombre">Nombre</label>
                            </div>
                             <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-size">
                                 <input class="mdl-textfield__input" type="text" name="apellido" value="<%=emple.getApellido()%>">
                                <label class="mdl-textfield__label" for="apellido">Apellido</label>
                            </div>
                             <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-size">
                                <input class="mdl-textfield__input" type="text" name="dni" value="<%=emple.getDni()%>">
                                <label class="mdl-textfield__label" for="dni">DNI</label>
                            </div>
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-size">
                                <input class="mdl-textfield__input" type="text" name="direccion" value="<%=emple.getDireccion()%>">
                                <label class="mdl-textfield__label" for="direccion">Dirección</label>
                            </div>
                             <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-size">
                                 <input class="mdl-textfield__input" type="text" name="fechaNac" value="<%=formato.format(emple.getFecha_nac())%>">
                                <label class="mdl-textfield__label" for="fechaNac">Fecha de nacimiento</label>
                            </div>
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-size">
                                <input class="mdl-textfield__input" type="text" name="nacionalidad" value="<%=emple.getNacionalidad()%>">
                                <label class="mdl-textfield__label" for="nacionalidad">Nacionalidad</label>
                            </div>
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-size">
                                <input class="mdl-textfield__input" type="text" name="celular" value="<%=emple.getCelular()%>">
                                <label class="mdl-textfield__label" for="celular">Celular</label>
                            </div>
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-size">
                                <input class="mdl-textfield__input" type="text" name="email" value="<%=emple.getEmail()%>">
                                <label class="mdl-textfield__label" for="email">E-mail</label>
                            </div>
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-size">
                                <input class="mdl-textfield__input" type="text" name="cargo" value="<%=emple.getCargo()%>">
                                <label class="mdl-textfield__label" for="cargo">Cargo</label>
                            </div>
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-size">
                                <input class="mdl-textfield__input" type="number" name="sueldo" value="<%=emple.getSueldo()%>">
