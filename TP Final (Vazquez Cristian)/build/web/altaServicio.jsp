            ...
            <div class="mdl-card mdl-shadow--2dp employer-form" action="#">
                ...
                <div class="mdl-card__supporting-text">
                        ...
                        <div class="form__article">
                            <form action="SvServicio" method="POST" class="form">
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-size">
                             ...
                             <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-size">
                                <input class="mdl-textfield__input" type="text" name="descrServ">
                                <label class="mdl-textfield__label" for="descripcion">Descripción</label>
                            </div>
                             <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-size">
                                <input class="mdl-textfield__input" type="text" name="origen">
                                <label class="mdl-textfield__label" for="origen">Origen</label>
                            </div>
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-size">
                                <input class="mdl-textfield__input" type="text" name="destino">
                                <label class="mdl-textfield__label" for="destino">Destino</label>
                            </div>
                             <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-size">
                                <input class="mdl-textfield__input" type="text" name="costo">
