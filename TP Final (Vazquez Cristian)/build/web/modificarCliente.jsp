        ...
        <main class="mdl-layout__content mdl-color--grey-100">
            <div class="mdl-card mdl-shadow--2dp employer-form" action="#">
                <div class="mdl-card__title">
                    ...
                    <div class="mdl-card__subtitle">Modifique los datos del cliente</div>
                </div>

                <div class="mdl-card__supporting-text">
                    <form action="SvModificarCliente2" method="POST" class="form">
                        <%Cliente cliente =(Cliente) session.getAttribute("clienteModif");%>
                                                
                        <div class="form__article">
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-size">
                                <input class="mdl-textfield__input" type="text" name="nombre" value="<%=cliente.getNombre() %>">
                                <label class="mdl-textfield__label" for="nombre">Nombre</label>
                            </div>
                             <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-size">
                                 <input class="mdl-textfield__input" type="text" name="apellido"value="<%=cliente.getApellido() %>">
                                <label class="mdl-textfield__label" for="apellido">Apellido</label>
                            </div>
                             <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-size">
                                <input class="mdl-textfield__input" type="text" name="dni" value="<%=cliente.getDni() %>">
                                <label class="mdl-textfield__label" for="dni">DNI</label>
                            </div>
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-size">
                                <input class="mdl-textfield__input" type="text" name="direccion" value="<%=cliente.getDireccion() %>">
                                <label class="mdl-textfield__label" for="direccion">Dirección</label>
                            </div>
                             <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-size">
                                
                                 
                                 <input class="mdl-textfield__input" type="text" name="fechaNac" value="<%=formato.format(cliente.getFecha_nac())%>">
                                <label class="mdl-textfield__label" for="fechaNac">Fecha de nacimiento</label>
                            </div>
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-size">
                                <input class="mdl-textfield__input" type="text" name="nacionalidad" value="<%=cliente.getNacionalidad() %>">
                                <label class="mdl-textfield__label" for="nacionalidad">Nacionalidad</label>
                            </div>
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-size">
                                <input class="mdl-textfield__input" type="text" name="celular" value="<%=cliente.getCelular() %>">
                                <label class="mdl-textfield__label" for="celular">Celular</label>
                            </div>
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-size">
                                <input class="mdl-textfield__input" type="text" name="email" value="<%=cliente.getEmail() %>">
