        ...
        <main class="mdl-layout__content mdl-color--grey-100">
            <div class="mdl-card mdl-shadow--2dp employer-form" action="#">
                <div class="mdl-card__title">
                    ...
                    <div class="mdl-card__subtitle">Modifique los datos del servicio</div>
                </div>

                <div class="mdl-card__supporting-text">
                    <form action="SvModificarServicio2" method="POST" class="form">
                        <% Servicio servi = (Servicio) misession.getAttribute("servicioModif");%>
                        <div class="form__article">
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-size">
                                
                                                              
                                <select class="mdl-textfield__input"  type="text" name="nombreServ">
                                    <option></option>
                                    <%HttpSession sesion = request.getSession();
                                    List <TipoDeServicio> listaTiSer = (List) sesion.getAttribute("listaTipoServicio");                               
                                    for (TipoDeServicio LTS : listaTiSer){%>
                                    <%String nombre = LTS.getNombre();%>
                                    <option class="black"><%=nombre%></option>
                                    <%}%>
                                </select>
                             ...
                             <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-size">
                                 <input class="mdl-textfield__input" type="text" name="descrServ" value="<%=servi.getDescripcion()%>">
                                <label class="mdl-textfield__label" for="descripcion">Descripción</label>
                            </div>
                             <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-size">
                                <input class="mdl-textfield__input" type="text" name="origen"value="<%=servi.getOrigen()%>">
                                <label class="mdl-textfield__label" for="origen">Origen</label>
                            </div>
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-size">
                                <input class="mdl-textfield__input" type="text" name="destino"value="<%=servi.getDestino()%>">
                                <label class="mdl-textfield__label" for="destino">Destino</label>
                            </div>
                             <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-size">
                                <input class="mdl-textfield__input" type="text" name="costo"value="<%=servi.getCosto()%>">
                                <label class="mdl-textfield__label" for="costo">Costo</label>
                            </div>
                                <<input type="hidden" name="id" value="<%=servi.getCodigo_serv()%>">
                            <div class="mdl-layout-spacer"></div>
                            <a href="index.jsp">
